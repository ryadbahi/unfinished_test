...
export declare type StringDecoder = (buf: Buffer, enc: string) => string;
export declare type StringEncoder = (str: string, enc: string) => Buffer;
export declare type LowLevelDecoder = (buf: Buffer, codepage: number, fontInfo: Readonly<FontTableEntry> | undefined, decoder: StringDecoder) => string | undefined;
...
export interface ProcessTokensGlobalState extends TokenCountGlobalState, GroupGlobalState, UnicodeSkipGlobalState, OutputGlobalState, ControlAndDestinationGlobalState, CharacterSetGlobalState, FontGlobalState, GlobalStateWithGroupState<ProcessTokensGroupState> {
